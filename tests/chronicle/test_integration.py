...
def test_chronicle_reference_lists():
    ...
    try:
        ...
        print(
            f"Note: Reference list {rl_name} remains since delete_reference_list is not implemented"
        )
...
def test_chronicle_reference_lists_cidr():
    ...
    try:
        ...
        # Note: The example code doesn't include a delete_reference_list function
        print(
            f"Note: CIDR reference list {rl_name} remains since delete_reference_list is not implemented"
        )
